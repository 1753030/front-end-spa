...
function DetailComponent(props) {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        temp1 = await axios
          .get(`http://localhost:1337/courses?id=${props.id}`)
  ...
  return (
    <Container
      style={{
        ...
        boxShadow: "0 8px 16px 0 rgba(0,0,0,0.1), 0 6px 6px 0 rgba(0,0,0,0.1)",
        paddingTop: 40,
        background: "#dddddd",
      }}
    >
          ...
          <div>
            <div id="accordion">
              <div class="card">
                ...
                >
                  {listCourse.map((item, index) => {
                    return <div class="card-body">{item.detailDes}</div>;
                  })}
                </div>
              </div>
              <div class="card">
